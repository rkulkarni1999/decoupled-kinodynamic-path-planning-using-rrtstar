...
def calculate_segment_times(waypoints):
    ...
    min_time, max_time = 1.5, 3  # Time in seconds for shortest and longest segments
...
def calculate_yaw_angles(waypoints, num_points=1000):
...
def generate_smooth_trajectory(waypoints, num_points=1000):
    waypoints = np.array(waypoints)
    segment_times = calculate_segment_times(waypoints)
    ...
    MP_trajectory_Matrix = np.array([[px_trajectory], [py_trajectory], [pz_trajectory],
                                     ...
                                     [ax_trajectory], [ay_trajectory], [az_trajectory], [yaw_position_trajectory]])
